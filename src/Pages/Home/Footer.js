  ...
  return (
    <footer className="footer--container">
      <div className="footer--link--container">
        <div>
          <img src=".//logo.png" alt="Portfolio" />RANI
        </div>
        ...
        <div className="footer--social--icon">
          <ul>
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/rani-a69b90230/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
      ...
      <div className="footer--content--container">
        <p className="footer--content">Made by Rani</p>
        <div className="footer--social--icon">
          <ul>
            <li>
              <Link
